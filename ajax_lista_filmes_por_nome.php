<?php 
	...
	require('bancodados/conexao.php');
		...
		$pesquisa_filme = $_GET['pesquisa_filme'];
    
        $select_filmes_recentes = mysqli_query($conexao, "SELECT * FROM filmes WHERE titulo LIKE '%".$pesquisa_filme."%'  ORDER BY titulo ASC LIMIT 14");
